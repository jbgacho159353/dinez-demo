      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-10 text-center flex flex-col items-center gap-4">
          {visible < total ? (
            <button
              onClick={showMore}
              className="inline-flex items-center gap-2 bg-[#C8102E] hover:bg-[#A50D26] text-white font-bold px-8 py-3 rounded-full text-sm uppercase tracking-widest transition-all duration-200 hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#C8102E] hover:bg-[#A50D26] text-white font-bold px-8 py-3 rounded-full text-sm uppercase tracking-widest transition-all duration-200 hover:scale-105"
            >
