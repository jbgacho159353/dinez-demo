...
function FLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <a
        href={href}
        className="flex items-center gap-2 text-sm text-gray-300 hover:text-gold transition-colors duration-200 group"
      >
        <svg
...
function FHeading({ children }: { children: React.ReactNode }) {
  return (
    <h3 className="text-white text-sm font-semibold uppercase tracking-widest mb-5 pb-3 border-b border-white/20">
      {children}
    </h3>
  );
}
    ...
    <footer id="contact" className="bg-[#1A237E] border-t-2 border-gold">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-200 text-sm leading-relaxed mb-1 font-medium">Your Global Travel Certainty</p>
            ...
            <div className="flex items-center gap-2 flex-wrap mb-5">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-gray-300 hover:text-gold hover:border-gold/40 transition-all duration-200"
                >
            ...
            {/* Payment */}
            <div>
              <p className="text-gray-400 text-[10px] uppercase tracking-wider mb-1">Payments accepted</p>
              <p className="text-gray-300 text-xs">Visa · Mastercard · Amex · Cash · Bank Transfer · Invoice</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 mb-7">
              ...
              <li className="flex items-start gap-3 text-sm text-gray-300">
                <svg className="w-5 h-5 text-green-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-3 bg-gold/10 border border-gold/30 rounded-xl text-xs text-gray-300">
      ...
      <div className="border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-300">
