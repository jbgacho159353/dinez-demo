...
const services = [
  {
    ...
    img: "/assets/airport-transfer-in-Farnborough_edited_j.avif",
    icon: (
  ...
  {
    key: "chauffeurServices",
    href: "/chauffeur-services",
    img: "/assets/Dinez-Chauffeur-female-client-interacting-formal-way.avif",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    key: "cruisePortTransfers",
    href: "/cruise-port-transfers",
    img: "/assets/Dinez-Cruise-Port-Transfers.avif",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    key: "dayTours",
    href: "/day-tours",
    img: "/assets/Dinez-UK-Marching-Guard-British-Ceremonial-Parade.avif",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    key: "eventsOccasions",
    href: "/events",
    img: "/assets/Dinez-Event-Royal-Ascot-Chauffeur.avif",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    key: "weddingChauffeur",
    href: "/wedding-chauffeur",
    img: "/assets/Dinez-Wedding-Chauffeur.avif",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          ...
          {services.map(({ key, href, img, icon }) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center gap-2 text-[#C8102E] text-xs uppercase tracking-widest group-hover:text-[#A50D26] transition-colors duration-300">
