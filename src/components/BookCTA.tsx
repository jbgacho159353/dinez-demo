    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#1A237E] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/en/book-a-taxi" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-[#F8F9FA] text-[#1A237E] font-bold px-8 py-4 rounded-full text-sm uppercase tracking-widest transition-all duration-300 shadow-lg hover:scale-105">
          ...
          <a href="tel:+4401252265363" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-white hover:text-[#1A237E] px-8 py-4 rounded-full text-sm uppercase tracking-widest transition-all duration-300">
