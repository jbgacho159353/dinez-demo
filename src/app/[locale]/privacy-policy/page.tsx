...
const sections = [
  { title:"1. Who We Are", body:"Dinez Executive Taxis (\"Dinez\", \"we\", \"our\") is the data controller for the personal information you provide to us. Our registered address is 45 Royal Drive, London EC1A 1BB, United Kingdom. Contact: bookings@dinez-executive.com · +63 912 345 6789." },
  ...
  { title:"6. Your Rights Under UK GDPR", body:"You have the right to: access a copy of your personal data; correct inaccurate data; request erasure (right to be forgotten); object to processing; restrict processing; data portability. To exercise any right, email bookings@dinez-executive.com. We will respond within 30 days. You also have the right to lodge a complaint with the ICO at ico.org.uk." },
  ...
  { title:"10. Contact Us", body:"For any privacy-related queries or to exercise your rights, contact our Data Protection contact: Dinez Executive Taxis · bookings@dinez-executive.com · 45 Royal Drive, London EC1A 1BB · +63 912 345 6789." },
];
  ...
  return (
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">
      <div className="bg-gold/5 border border-gold/20 rounded-xl p-5 mb-8 text-sm text-gray-300">
        <strong className="text-gold">UK GDPR Compliant</strong> · Last Updated: January 2025 · Controller: Dinez Executive Taxis, 45 Royal Drive, London EC1A 1BB
      </div>
