      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white border border-gray-200 rounded-2xl p-7">
            <h2 className="text-2xl font-playfair font-bold text-[#1A237E] mb-5">Services Overview</h2>
            <div className="space-y-3">
              {services.map(s=>(
                <div key={s} className="flex items-center gap-3"><svg className="w-5 h-5 text-gold shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg><span className="text-gray-700 text-sm">{s}</span></div>
              ))}
            </div>
          </div>
          <div className="bg-white border border-gray-200 rounded-2xl p-7">
            <h2 className="text-2xl font-playfair font-bold text-[#1A237E] mb-5">Fleet Summary</h2>
        ...
        <div className="space-y-5">
          <div className="bg-gold/5 border border-gold/30 rounded-2xl p-7 text-center sticky top-24">
            ...
            <h3 className="text-xl font-playfair font-bold text-[#1A237E] mb-3">Download PDF</h3>
            <p className="text-gray-600 text-sm mb-6">Full brochure including pricing guide, fleet photos and service details.</p>
            ...
            <div className="mt-6 pt-5 border-t border-gray-200 text-xs text-gray-500 space-y-1">
