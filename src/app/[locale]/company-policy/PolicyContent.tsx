  ...
  return (
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="bg-dark-card border border-dark-border rounded-xl p-6 text-sm text-gray-500">
        <p>Last updated: January 2025. Dinez Executive Taxis is licensed by Transport for Greater London (Licence: TFL-2025-DEM-001). For queries regarding these policies, contact <a href="mailto:bookings@dinez-executive.com" className="text-gold hover:underline">bookings@dinez-executive.com</a>.</p>
      </div>
    </div></section>
