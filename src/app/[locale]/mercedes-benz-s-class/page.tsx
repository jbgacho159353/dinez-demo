...
export const metadata: Metadata = {
  title: "Mercedes S-Class | Dinez Executive Taxis",
  description: "The Pinnacle of Luxury — VIP Travel Redefined — Premium executive chauffeur service in Aldershot, Hampshire and beyond.",
};
  ...
  return (
    <main className="bg-dark min-h-screen">
      ...
      <PageHero
        ...
        subtitle="The Pinnacle of Luxury — VIP Travel Redefined"
        breadcrumb="Our Fleet"
        bgImage="https://images.unsplash.com/photo-1563720223185-11003d516935?w=1920&q=80"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              ...
              { label: "Suitcases", value: "3" },
              { label: "Carry-on Bags", value: "2" },
              { label: "Class", value: "VIP" },
            ].map(s => (
              <div key={s.label}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="/book-a-taxi?vehicle=s-class" className="inline-flex items-center justify-center gap-2 bg-gold hover:bg-gold-dark text-black font-bold px-7 py-3.5 rounded-full text-sm uppercase tracking-wider transition-all shadow-lg shadow-gold/20 hover:scale-105">
                  Book This Vehicle
                </a>
      ...
      <BookCTA heading="Book the Mercedes S-Class Today" />
      <Footer />
      <WhatsAppButton />
    </main>
  );
